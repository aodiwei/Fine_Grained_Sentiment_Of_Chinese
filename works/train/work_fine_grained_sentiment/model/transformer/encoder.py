...
class Encoder(TransformerBaseClass):
    def __init__(self, d_model, d_k, d_v, sequence_length, h, batch_size, num_layer, Q, K_s, type='encoder', mask=None,
                 dropout_keep_prob=None, use_residual_conn=True):
        """
        :param d_model:
        :param d_k:
        :param d_v:
    ...
    def encoder_single_layer(self, Q, K_s, layer_index):
        ...
        multi_head_attention_output = self.sub_layer_multi_head_attention(layer_index, Q, K_s, self.type, mask=self.mask,
        ...
        postion_wise_feed_forward_output = self.sub_layer_layer_norm_residual_connection(multi_head_attention_output,
                                                                                         postion_wise_feed_forward_output, layer_index,
                                                                                         'encoder_postion_wise_ff',
                                                                                         dropout_keep_prob=self.dropout_keep_prob)
