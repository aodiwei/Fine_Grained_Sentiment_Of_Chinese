...
class PositionWiseFeedFoward:  # TODO make it parallel
    """
    ...
    def position_wise_feed_forward_fn(self):
        ...
        output_conv2 = tf.nn.conv2d(ouput_conv1, filter2, strides=[1, 1, 1, 1], padding="VALID",
                                    name="conv2")  # [batch,sequence_length,1,d_model]
