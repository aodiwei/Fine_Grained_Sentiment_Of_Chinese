...
from works.train.work_fine_grained_sentiment.model.transformer.multi_head_attention import MultiHeadAttention
from works.train.work_fine_grained_sentiment.model.transformer.poistion_wise_feed_forward import PositionWiseFeedFoward
from works.train.work_fine_grained_sentiment.model.transformer.layer_norm_residual_conn import LayerNormResidualConnection


class TransformerBaseClass:
    """
    ...
    def sub_layer_multi_head_attention(self, layer_index, Q, K_s, type, mask=None, is_training=None,
        ...
        with tf.variable_scope("base_mode_sub_layer_multi_head_attention_" + type + str(layer_index)):
            ...
            multi_head_attention_class = MultiHeadAttention(Q, K_s, V_s, self.d_model, self.d_k, self.d_v, self.sequence_length,
                                                            self.h, type=type, is_training=is_training, mask=mask,
    ...
    def sub_layer_layer_norm_residual_connection(self, layer_input, layer_output, layer_index, type, dropout_keep_prob=None,
        ...
        layer_norm_residual_conn = LayerNormResidualConnection(layer_input, layer_output, layer_index, type,
